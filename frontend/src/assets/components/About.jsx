              ...
              <div className="col-12 col-md-6">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="text-secondary mb-0">We are crafting a digital method that subsists comfort across all mediums.</p>
                  </div>
                </div>
              </div>
              <div className="col-12 col-md-6">
                <div className="d-flex">
                  ...
                  <div>
                    ...
                    <p className="text-secondary mb-0">Empowering clients and service providers for seamless connections and trusted solutions
